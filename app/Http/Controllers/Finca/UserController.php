    ...
    */
    ...
    public  function updateTDispositivos(Request $request)
    {
        ...
        $where=[
            ...
            "EMERITA JAMILETH BUSTAMANTE ARDÓN",
            "ENA ROSARIO BRAN ALVARADO",
            "FANY YESSENIA FLORES ESPINAL",
            "GABRIELA ELIZABETH RODRÍGUEZ ORDOÑEZ",
            "GLORIA SUYAPA ANDRADE LAGOS",
            "GREYSI NOHEMY HERRERA VELASQUEZ",
            ...
            "SELENA MARICRUZ RODRIGUEZ FERRUFINO",
            "STEPHANY SARAHY VALLE CARRANZA",
